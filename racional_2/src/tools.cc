...
void Func(const std::string kInputFileName, const std::string kOutputFileName){
    int suma_numeradores{0}, suma_denominadores{0}, contador{0};
    ...
    while(input_file >> racional_texto_1 >> racional_texto_2){
        ...
        suma_numeradores += racional_1.getNumerador() + racional_2.getNumerador();
        suma_denominadores += racional_1.getDenominador() + racional_2.getDenominador();
        contador += 2;
    }

    output_file << "La media de los numeradores es: " << suma_numeradores / contador << std::endl;
    output_file << "La media de los denominadores es : " << suma_denominadores / contador << std::endl;
